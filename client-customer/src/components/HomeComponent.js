      ...
      <div>
        ...
        <div className="footer">
          <div className="footer-grid">
            ...
            <div className="footer-col"><h4>Platform</h4><a>How it works</a><a>Pricing</a><a>Photographers</a><a>Become a pro</a></div>
            <div className="footer-col"><h4>Support</h4><a>Help center</a><a>Contact us</a><a>Cancellation</a><a>Trust & safety</a></div>
            <div className="footer-col"><h4>Contact</h4><a>shotoflife@gmail.com</a><a>+84 123 456 789</a><a>TP. Ho Chi Minh</a></div>
          </div>
