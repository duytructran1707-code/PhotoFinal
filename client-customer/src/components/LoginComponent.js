      ...
      <div className="auth-page">
        <div className="auth-split">
          ...
          <div className="auth-footer">
            Don't have an account? <button onClick={() => this.props.navigate('/signup')} style={{ cursor:'pointer', background:'none', border:'none', color:'inherit', font:'inherit', padding:0, textDecoration:'underline' }}>Sign up</button>
          </div>
            </div>
          </div>
        </div>
